...
\begin{document}
    ...
    \section{Példa szimuláció}
        ...
        \subsection{A számítás menete}
            ...
            \end{align}
            Az előrelépő Euler séma időléptetése \aref{equ:fe}. egyenletben látható.
            \par
            A  Maxwell-egyenleteknek a modellben használt alakja \aref{equ:maxwell}. egyenletben látható.
